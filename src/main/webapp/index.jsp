<%@ page contentType="text/html;charset=UTF-8" language="java" %>
    ...
    <head>
        ...
        <meta name="description"
            content="Empowering education with UniTRS. The modern University Management System for students, professors, and administrators.">
    ...
    <body>
        ...
        <nav class="navbar navbar-custom d-flex justify-content-between align-items-center">
            ...
            <div class="d-flex align-items-center gap-3">
                <button id="pwaInstallBtn" class="btn btn-outline-info rounded-pill px-3 py-2 text-decoration-none"
                    style="display: none;" onclick="window.promptPwaInstall()">
                    <i class="bi bi-download me-1"></i> Install App
                </button>
                <a href="${pageContext.request.contextPath}/auth/login"
                    class="text-decoration-none nav-link-custom d-none d-md-block">Sign In</a>
                <a href="${pageContext.request.contextPath}/auth/register"
                    class="btn btn-gradient text-decoration-none">Get Started</a>
            </div>
        </nav>
        ...
        <section class="hero">
            ...
            <div class="container">
                ...
                <p>Welcome to UniTRS, the next-generation University Management System designed to seamlessly connect
                    students, professors, and administrators.</p>
                <div class="hero-buttons">
                    <a href="${pageContext.request.contextPath}/auth/register"
                        class="btn btn-gradient rounded-pill text-decoration-none">Join Now</a>
                    <a href="${pageContext.request.contextPath}/auth/login"
                        class="btn btn-glass rounded-pill text-decoration-none">Sign In</a>
                </div>
            </div>
        </section>
