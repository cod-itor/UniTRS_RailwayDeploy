...
<head>
    ...
    <title>UniTRS - Verify Email</title>
...
<body>
    <div class="card-custom">
        ...
        <div class="subtitle">Account Email Verification</div>
        ...
        <form action="${pageContext.request.contextPath}/auth/verify-registration" method="POST">
            ...
            <div class="mb-4">
                <label for="otpCode" class="form-label fw-semibold text-center w-100">Enter Verification Code</label>
        ...
        <div class="d-flex justify-content-between align-items-center mt-3 pt-3 border-top">
            <form action="${pageContext.request.contextPath}/auth/resend-registration-otp" method="POST" class="d-inline">
                <input type="hidden" name="email" value="${email}">
