...
<body>
    <div class="card-custom">
        ...
        <p class="text-center text-muted mb-4">
            Security Check: Enter the 6-digit login code sent to: <br>
            <strong class="text-dark">${email}</strong>
        </p>

        <form action="${pageContext.request.contextPath}/auth/verify-2fa" method="POST">
            <div class="mb-4">
                <label for="otpCode" class="form-label fw-semibold text-center w-100">Enter 2FA Code</label>
                ...
                <div class="form-text text-center">Code expires in 5 minutes.</div>
            </div>

            <button type="submit" class="btn btn-primary w-100 py-2 fw-semibold mb-3">
                <i class="bi bi-box-arrow-in-right me-1"></i> Verify & Sign In
            </button>
        </form>
