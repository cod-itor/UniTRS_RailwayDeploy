...
<head>
    ...
    <title>UniTRS - Two-Factor Authentication</title>
...
<body class="auth-page">
    ...
    <c:if test="${not empty error}">
        <div class="sonner-flash-trigger d-none" data-type="error" data-title="2FA Failed" data-message="<c:out value='${error}' />"></div>
    </c:if>
    <c:if test="${not empty info}">
        <div class="sonner-flash-trigger d-none" data-type="info" data-title="Security Code Sent" data-message="<c:out value='${info}' />"></div>
    </c:if>
    ...
    <div class="auth-container">
        <div class="auth-card">
            ...
            <div class="text-center mb-3">
                ...
                <div class="auth-subtitle mb-3">Security Verification Required</div>
            </div>
            ...
            <form action="${pageContext.request.contextPath}/auth/verify-2fa" method="POST">
                <div class="mb-4 text-center">
                    ...
                    <div class="form-text text-secondary mt-2 small">This code will expire in 5 minutes.</div>
                </div>
            ...
            <div class="d-flex justify-content-between align-items-center mt-3 pt-3 border-top border-secondary border-opacity-25">
                <form action="${pageContext.request.contextPath}/auth/resend-2fa-otp" method="POST" class="d-inline">
